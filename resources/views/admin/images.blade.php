                    ...
                    <div class="card-title-wrap bar-success d-flex justify-content-between align-items-center">
                      <form class="form-group mb-0 d-flex">
                        <div class="position-relative has-icon-left">
                          <input type="text" class="form-control" name="form-control-with-icon" placeholder="Name of image..." ng-model="keyword">
                        ...
                        <div class="d-flex ml-4 align-items-center">
                          ...
                          <select class="form-control" name="color-search" id="color-search" ng-options="row.id as row.color for row in colors" ng-model="product_color_id">
                          </select>
                        </div>
                      </form>
                  ...
                  <div class="card-body">
                    <div class="card-block">
                      <table class="table table-responsive-md text-center ">
                        ...
                        <tbody>
                          <tr dir-paginate="row in data|filter: {image: keyword, product_color_id: product_color_id}|itemsPerPage:10" current-page="currentPage">
                            <td>@{{$index + serial}}</td>
          ...
          <div class="form-body step js-steps-content" id="step1">
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <label for="" class="mr-2">Color</label>
                <select class="form-control" name="product" id="product" ng-options="row.id as row.color for row in colors" ng-model="item.product_color_id">
                </select>
              </div>
