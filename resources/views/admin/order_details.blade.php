...
@section('content')
<div ng-controller="order_detailsController">
                  ...
                  <div class="card-body">
                    <div class="card-block">
                      <table class="table table-responsive-md text-center ">
                        ...
                        <tbody>
                          <tr dir-paginate="row in data|filter: {product_id: product_id}|itemsPerPage:10" current-page="currentPage">
                            <td>@{{$index + serial}}</td>
                            <td>@{{row.order.id}}</td>
                            <td>@{{row.order.customer.info.full_name}}</td>
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  ...
                  <select class="form-control" name="order" id="order" ng-options="row.id as row.delivery_address for row in orders" ng-model="item.order_id">
                  </select>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
              ...
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  ...
                  <input type="number" class="form-control" id="quantity" ng-model="item.quantity" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="single_price">Single price</label>
                  <input type="number" class="form-control" id="single_price" ng-model="item.single_price" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
              ...
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  ...
                  <input type="text" class="form-control" id="size" ng-model="item.size" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
              <fieldset class="form-group">
                  ...
                  <div class="row">
                    <img ng-if="item.image != '' || item.image != null" ng-src="/assets/img/products/@{{item.image}}" id="img_prv" style="max-width: 150px;max-height: 150px" class="img-image" alt="">
                  </div>
                </fieldset>
              </div>
            </div>
...
<script src="/assets/js/controllers/order_detailsController.js"></script>
@stop