...
@section('content')
<div ng-controller="order_statusesController">
                  ...
                  <div class="card-body">
                    <div class="card-block">
                      <table class="table table-responsive-md text-center ">
                        ...
                        <tbody>
                          <tr dir-paginate="row in data|filter: {status_name: keyword}|itemsPerPage:10" current-page="currentPage">
                            <td>@{{row.id}}</td>
          ...
          <div class="form-body step js-steps-content" id="step1">
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                ...
                <input type="text" class="form-control" id="" ng-model="item.status_name" require>
              </div>
            </div>
          </div>
        </div>
...
<script src="/assets/js/controllers/order_statusesController.js"></script>
@stop