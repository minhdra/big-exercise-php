            ...
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  ...
                  <input type="text" class="form-control" id="item-name" ng-model="item.name" placeholder="Name"  require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="address">Address</label>
                  <input type="text" class="form-control" id="address" ng-model="item.address" placeholder="Address" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="email">Email</label>
                  <input type="text" class="form-control" id="email" ng-model="item.email" placeholder="Email" require>
                </fieldset>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-12 mb-1">
                <fieldset class="form-group">
                  <label for="phone_number">Phone number</label>
                  <input type="text" class="form-control" id="phone_number" ng-model="item.phone_number" placeholder="Phone Number" required>
                </fieldset>
              </div>
            </div>
          </div>
...
<script src="/assets/js/controllers/suppliersController.js"></script>
@stop