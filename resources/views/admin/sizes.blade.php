...
@section('content')
<div ng-controller="sizesController">
                  ...
                  <div class="card-body">
                    <div class="card-block">
                      <table class="table table-responsive-md text-center ">
                        ...
                        <tbody>
                          <tr dir-paginate="row in data|filter: {size: keyword, product_color_id: product_color_id}|itemsPerPage:10" current-page="currentPage">
                            <td>@{{$index + serial}}</td>
...
<script src="/assets/js/controllers/sizesController.js"></script>
@stop