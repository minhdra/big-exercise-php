          ...
          <nav class="header__menu--navigation">
            <ul class="d-flex">
              <li class="header__menu--items style2">
                <a class="header__menu--link text-white" href="/">Home
              ...
              <li class="header__menu--items mega__menu--items style2">
                <a class="header__menu--link text-white" href="/shop">Shop
                  <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                    <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                  </svg>
                </a>
                <ul class="header__mega--menu d-flex">
                  <li class="header__mega--menu__li">
                    ...
                    <ul class="header__mega--sub__menu">
                      <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Shop Left Sidebar</a></li>
                      ...
                      <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Shop Grid</a></li>
                  ...
                  <li class="header__mega--menu__li">
                    ...
                    <ul class="header__mega--sub__menu">
                      <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop/@{{row.id}}">Product Details</a></li>
                      <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-video.html">Video Product</a></li>
                      <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop/@{{row.id}}">Variable Product</a></li>
              ...
              <li class="header__menu--items style2 d-none d-xl-block">
                <a class="header__menu--link text-white" href="/shop">Categories </a>
              </li>
              <li class="header__menu--items style2">
          ...
          <li class="offcanvas__menu_li">
            ...
            <ul class="offcanvas__sub_menu">
              <li class="offcanvas__sub_menu_li">
                ...
                <ul class="offcanvas__sub_menu">
                  <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/shop">Shop Left Sidebar</a></li>
              ...
              <li class="offcanvas__sub_menu_li">
                ...
                <ul class="offcanvas__sub_menu">
                  <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/shop/@{{row.id}}">Product Details</a></li>
                  <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-video.html">Video Product</a></li>
                  <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="/shop/@{{row.id}}">Variable Product</a></li>
    ...
    <div class="minicart__product" ng-if="customer.username">
      <div class="minicart__product--items d-flex" ng-if="customer.cart_details.length > 0" ng-repeat="row in customer.cart_details">
        ...
        <div class="minicart__text">
          <h3 class="minicart__subtitle h4"><a href="/shop/@{{row.product_id}}">@{{row.name}}</a></h3>
      ...
      <div class="minicart__product--items d-flex" ng-if="customer.cart_details.length === 0">
        <h5 class="h5" style="padding: 1rem 0;">You haven't any cart! <a class="minicart__button--link" href="/shop">Shopping now!</a></h5>
      </div>
    </div>
