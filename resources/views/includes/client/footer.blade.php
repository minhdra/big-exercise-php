<footer class="footer__section bg__black" ng-controller="headerClientController">
  <div class="container-fluid">
    <div class="main__footer d-flex justify-content-between">
      <div class="footer__widget footer__widget--width">
        ...
        <div class="footer__widget--inner">
          <p class="footer__widget--desc text-ofwhite mb-20">+84-964-247-841 <br />Tu Dan, Khoai Chau, Hung Yen</p>
      ...
      <div class="footer__widget footer__widget--width">
        <div class="footer__widget">
          ...
          <ul class="footer__widget--menu footer__widget--inner">
            <li class="footer__widget--menu__list" ng-repeat="row in categories"><a class="footer__widget--menu__text" href="/shop?category=@{{row.id}}">@{{row.name}}</a></li>
          </ul>
        </div>
      </div>
      <div class="footer__widget footer__widget--width">
    ...
    <div class="footer__bottom d-flex justify-content-between align-items-center">
      <p class="copyright__content text-ofwhite m-0">Copyright © 2022 LeMinh. I used template of <a class="copyright__content--link" href="{{route('index')}}">Suruchi</a> . All Rights Reserved.Design By Suruchi</p>
