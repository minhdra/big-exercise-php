...
@section('content')
<main class="main__content_wrapper" ng-controller="customersController" ng-init="checkLogin()">
            ...
            <div class="col">
              <div class="account__login">
                ...
                <div class="account__login--inner">
                  <input class="account__login--input" placeholder="Username" type="text" spellcheck="false" data-ms-editor="true" ng-model="requestLogin.username" autocomplete>
                  ...
                  <button class="account__login--btn primary__btn" type="submit" ng-click="login()">Login</button>
