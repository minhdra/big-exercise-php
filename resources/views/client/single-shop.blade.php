...
@section('content')
<main class="main__content_wrapper" ng-controller="singleProductController" ng-init="getSimilar()">
          ...
          <div class="product__details--media">
            ...
            <div class="product__media--nav swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode swiper-thumbs">
              <div class="swiper-wrapper" id="swiper-wrapper-daeccb1b4d7ded42" aria-live="polite" style="transform: translate3d(-580px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide" style="width: 106px; margin-right: 10px;" ng-repeat="row in item.colors[colorIndex].images" ng-click="showImage(row)">
              ...
              <div id="description" class="tab_pane active show">
                <div class="product__tab--content">
                  <div class="product__tab--content__step mb-30">
                    <h2 class="product__tab--content__title h4 mb-10">@{{item.name}}</h2>
                    <p class="product__tab--content__desc" id="des-single"></p>
                  </div>
  ...
  <section class="product__section product__section--style3 section--padding" style="padding-top:0;">
    <div class="container product3__section--container">
      ...
      <div class="product__section--inner product__swiper--column4__activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
        <div class="swiper-wrapper" id="swiper-wrapper-8f3ae114ee77789a" aria-live="polite">
          <div class="swiper-slide" ng-repeat="row in dataSimilar">
...
@stop
@section('js')
<script src="/assets/js/controllers/client/singleProductController.js"></script>
@stop