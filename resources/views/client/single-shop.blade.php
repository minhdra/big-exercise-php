...
@section('content')
<main class="main__content_wrapper" ng-controller="singleController">
  <input type="text" id="product_id" hidden value="{{$id}}">
        ...
        <div class="col">
          <div class="breadcrumb__content text-center">
            ...
            <ul class="breadcrumb__content--menu d-flex justify-content-center">
              ...
              <li class="breadcrumb__content--menu__items"><a class="text-white" href="/shop">Shop</a></li>
        ...
        <div class="col">
          <div class="product__details--media">
            <div class="product__media--preview swiper swiper-initialized swiper-horizontal swiper-pointer-events">
              <div class="swiper-wrapper" id="swiper-wrapper-cb7ca4a6fdb9eb67" aria-live="polite" style="transform: translate3d(-580px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide" style="width: 570px; margin-right: 10px;" role="group" ng-repeat="row in item.colors[colorIndex].images">
            ...
            <div class="product__media--nav swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode swiper-thumbs">
              <div class="swiper-wrapper" id="swiper-wrapper-daeccb1b4d7ded42" aria-live="polite" style="transform: translate3d(-580px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide" style="width: 106px; margin-right: 10px;" ng-repeat="row in item.colors[colorIndex].images">
                  <div class="product__media--nav__items">
                    <img class="product__media--nav__items--img" ng-src="/assets/img/products/@{{row.image}}" alt="product-nav-img">
                  </div>
                </div>
              </div>
              <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-daeccb1b4d7ded42"></div>
              <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-daeccb1b4d7ded42"></div>
              <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
          </div>
        </div>
          ...
          <div class="product__details--info">
            <div>
              ...
              <div class="product__details--info__price mb-10">
                ...
                <span class="@{{item.price.price_current == 0 ? '' : 'price__divided'}} "></span>
              ...
              <div class="guarantee__safe--checkout">
                ...
                <img class="guarantee__safe--checkout__img" ng-src="/assets/img/other/safe-checkout.png" alt="Payment Image">
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="reviews__comment--area">
                    <div class="reviews__comment--list d-flex">
                      <div class="reviews__comment--thumb">
                        <img ng-src="/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                      </div>
                    ...
                    <div class="reviews__comment--list margin__left d-flex">
                      <div class="reviews__comment--thumb">
                        <img ng-src="/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                      </div>
                      <div class="reviews__comment--content">
                        <div class="reviews__comment--top d-flex justify-content-between">
                          <div class="reviews__comment--top__left">
                    ...
                    <div class="reviews__comment--list d-flex">
                      <div class="reviews__comment--thumb">
                        <img ng-src="/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                      </div>
                      <div class="reviews__comment--content">
                        <div class="reviews__comment--top d-flex justify-content-between">
                          <div class="reviews__comment--top__left">
                    ...
                    <form action="#">
                      ...
                      <div class="row">
                        <div class="col-12 mb-10">
                          <textarea class="reviews__comment--reply__textarea" placeholder="Your Comments...." spellcheck="false" data-ms-editor="true"></textarea>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-15">
                          <label>
                            <input class="reviews__comment--reply__input" placeholder="Your Name...." type="text" spellcheck="false" data-ms-editor="true">
                          </label>
                        </div>
                        <div class="col-lg-6 col-md-6 mb-15">
                          <label>
  ...
  <section class="product__section product__section--style3 section--padding">
    <div class="container product3__section--container">
      ...
      <div class="product__section--inner product__swiper--column4__activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
        <div class="swiper-wrapper" id="swiper-wrapper-8f3ae114ee77789a" aria-live="polite" style="transform: translate3d(-1200px, 0px, 0px); transition-duration: 0ms;">
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" style="width: 270px; margin-right: 30px;" role="group" aria-label="4 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product8.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product15.png" alt="product-img">
                </a>
              ...
              <div class="product__items--content">
                ...
                <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Square Shoulder Bag</a></h4>
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 270px; margin-right: 30px;" role="group" aria-label="5 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product12.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product13.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
                </div>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Wool-blend Jacket</a></h4>
                <div class="product__items--price">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" style="width: 270px; margin-right: 30px;" role="group" aria-label="6 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product14.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product15.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Western denim shirt</a></h4>
                <div class="product__items--price">
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="6" style="width: 270px; margin-right: 30px;" role="group" aria-label="7 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product11.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product8.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
                </div>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Aware organic cotton</a></h4>
                <div class="product__items--price">
          ...
          <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 270px; margin-right: 30px;" role="group" aria-label="1 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product1.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product2.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
                </div>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h3 class="product__items--content__title h4"><a href="/shop/@{{row.id}}">Oversize Cotton Dress</a></h3>
                <div class="product__items--price">
          ...
          <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" style="width: 270px; margin-right: 30px;" role="group" aria-label="2 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product3.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product4.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
                </div>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h3 class="product__items--content__title h4"><a href="/shop/@{{row.id}}">Boxy Denim Jacket</a></h3>
                <div class="product__items--price">
          ...
          <div class="swiper-slide" data-swiper-slide-index="2" style="width: 270px; margin-right: 30px;" role="group" aria-label="3 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product5.png" alt="product-img">
                  <img class="product__items--img product__secondary--img" ng-src="/assets/img/product/product11.png" alt="product-img">
                </a>
                <div class="product__badge">
                  <span class="product__badge--items sale">Sale</span>
                </div>
              ...
              <div class="product__items--content">
                <span class="product__items--content__subtitle">Jacket, Women</span>
                <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Quilted Shoulder Bag</a></h4>
                <div class="product__items--price">
          ...
          <div class="swiper-slide" data-swiper-slide-index="3" style="width: 270px; margin-right: 30px;" role="group" aria-label="4 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product8.png" alt="product-img">
          ...
          <div class="swiper-slide" data-swiper-slide-index="4" style="width: 270px; margin-right: 30px;" role="group" aria-label="5 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product12.png" alt="product-img">
          ...
          <div class="swiper-slide" data-swiper-slide-index="5" style="width: 270px; margin-right: 30px;" role="group" aria-label="6 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product14.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="6" style="width: 270px; margin-right: 30px;" role="group" aria-label="7 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product11.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 270px; margin-right: 30px;" role="group" aria-label="1 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product1.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" style="width: 270px; margin-right: 30px;" role="group" aria-label="2 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product3.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 270px; margin-right: 30px;" role="group" aria-label="3 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" ng-src="/assets/img/product/product5.png" alt="product-img">
        ...
        <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-8f3ae114ee77789a"></div>
        <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-8f3ae114ee77789a"></div>
        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
      </div>
    </div>
  </section>
      ...
      <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
        <div class="shipping__items2 d-flex align-items-center">
          <div class="shipping__items2--icon">
            <img ng-src="/assets/img/other/shipping1.png" alt="">
          </div>
        ...
        <div class="shipping__items2 d-flex align-items-center">
          <div class="shipping__items2--icon">
            <img ng-src="/assets/img/other/shipping2.png" alt="">
          </div>
          <div class="shipping__items2--content">
        ...
        <div class="shipping__items2 d-flex align-items-center">
          <div class="shipping__items2--icon">
            <img ng-src="/assets/img/other/shipping3.png" alt="">
          </div>
          <div class="shipping__items2--content">
        ...
        <div class="shipping__items2 d-flex align-items-center">
          <div class="shipping__items2--icon">
            <img ng-src="/assets/img/other/shipping4.png" alt="">
          </div>
          <div class="shipping__items2--content">
