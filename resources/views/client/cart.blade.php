...
@section('content')
<main class="main__content_wrapper" ng-controller="headerClientController">
  ...
  <!-- cart section start -->
  <section class="cart__section section--padding" ng-if="customer.username">
                    ...
                    <tr class="cart__table--body__items" ng-repeat="row in customer.cart_details">
                      <td class="cart__table--body__list">
                        <div class="cart__product d-flex align-items-center">
                          <button class="cart__remove--btn" aria-label="search button" type="button" ng-click="remove(row.id, $index)">
                      ...
                      <td class="cart__table--body__list">
                        <span class="cart__price">$@{{row.single_price}}</span>
                      </td>
                      <td class="cart__table--body__list">
                        <div class="quantity__box">
                          <button type="button" class="quantity__value quickview__value--quantity decrease" aria-label="quantity value" value="Decrease Value" ng-click="changedCount(1, $index)">-</button>
                          <label>
                            <input type="number" class="quantity__number quickview__value--number" ng-model="row.quantity" data-counter="">
                          </label>
                          <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value" ng-click="changedCount(0, $index)">+</button>
                        </div>
                      </td>
                      <td class="cart__table--body__list">
                        <span class="cart__price end">$@{{row.single_price*row.quantity}}</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="cart__summary border-radius-10">
                <div class="coupon__code mb-30">
                  ...
                  <div class="coupon__code--field d-flex">
                    <label>
                      <input class="coupon__code--field__input border-radius-5" placeholder="Coupon code" type="text" spellcheck="false" data-ms-editor="true">
                    </label>
  ...
  <section class="product__section section--padding pt-0">
    <div class="container-fluid">
      ...
      <div class="product__section--inner product__swiper--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
        <div class="swiper-wrapper" id="swiper-wrapper-f916e54d83974be3" aria-live="polite" style="transform: translate3d(-2051px, 0px, 0px); transition-duration: 0ms;">
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" style="width: 263px; margin-right: 30px;" role="group" aria-label="3 / 7">
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="3" style="width: 263px; margin-right: 30px;" role="group" aria-label="4 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 263px; margin-right: 30px;" role="group" aria-label="5 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" style="width: 263px; margin-right: 30px;" role="group" aria-label="6 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="6" style="width: 263px; margin-right: 30px;" role="group" aria-label="7 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide" data-swiper-slide-index="0" style="width: 263px; margin-right: 30px;" role="group" aria-label="1 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" style="width: 263px; margin-right: 30px;" role="group" aria-label="2 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
          ...
          <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" style="width: 263px; margin-right: 30px;" role="group" aria-label="3 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product5.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="3" style="width: 263px; margin-right: 30px;" role="group" aria-label="4 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product8.png" alt="product-img">
          ...
          <div class="swiper-slide" data-swiper-slide-index="4" style="width: 263px; margin-right: 30px;" role="group" aria-label="5 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product12.png" alt="product-img">
          ...
          <div class="swiper-slide" data-swiper-slide-index="5" style="width: 263px; margin-right: 30px;" role="group" aria-label="6 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product14.png" alt="product-img">
          ...
          <div class="swiper-slide" data-swiper-slide-index="6" style="width: 263px; margin-right: 30px;" role="group" aria-label="7 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product11.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" style="width: 263px; margin-right: 30px;" role="group" aria-label="1 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product1.png" alt="product-img">
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" style="width: 263px; margin-right: 30px;" role="group" aria-label="2 / 7">
            <div class="product__items ">
              <div class="product__items--thumbnail">
                <a class="product__items--link" href="/shop/@{{row.id}}">
                  <img class="product__items--img product__primary--img" src="/assets/img/product/product3.png" alt="product-img">
        ...
        <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f916e54d83974be3"></div>
        <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f916e54d83974be3"></div>
