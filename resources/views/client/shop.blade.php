...
@section('content')
<main class="main__content_wrapper" ng-controller="shopController">
      ...
      <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
        ...
        <div class="product__view--mode d-flex align-items-center">
          <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
            <label class="product__view--label">Page :</label>
          ...
          <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
            ...
            <div class="select shop__header--select">
              <select class="product__view--select" ng-model="option" ng-options="row.value as row.label for row in sortOptions" ng-change="sorted(option)">
              </select>
            </div>
          </div>
          ...
          <div class="product__view--mode__list product__view--search d-none d-lg-block">
            <form class="product__view--search__form" action="#">
              <label>
                <input class="product__view--search__input border-0" placeholder="Search by" type="text" spellcheck="false" data-ms-editor="true" ng-model="keyword">
              </label>
        ...
        <p class="product__showing--count">Showing @{{itemsPerPage}} of @{{data.length}} results</p>
      </div>
      <div class="row">
          ...
          <div class="shop__sidebar--widget widget__area d-md-2-none">
            <div class="single__widget widget__bg">
              ...
              <ul class="widget__form--check">
                <li class="widget__form--check__list" ng-repeat="row in categories">
                  <label class="widget__form--check__label" for="check@{{row.id}}">@{{row.name}}</label>
                  <input class="widget__form--check__input" name="check-category" id="check@{{row.id}}" type="radio" ng-checked="row.id==search.category_id" ng-click="changedCategories(row.id)">
              ...
              <div class="product__grid--inner">
                <div class="product__items product__items--grid d-flex align-items-center">
                  ...
                  <div class="product__items--grid__content">
                    <h3 class="product__items--content__title h4"><a href="/shop/@{{row.id}}">Women Fish Cut</a></h3>
                ...
                <div class="product__items product__items--grid d-flex align-items-center">
                  ...
                  <div class="product__items--grid__content">
                    <h3 class="product__items--content__title h4"><a href="/shop/@{{row.id}}">Gorgeous Granite is</a></h3>
                    <div class="product__items--price">
                ...
                <div class="product__items product__items--grid d-flex align-items-center">
                  ...
                  <div class="product__items--grid__content">
                    <h4 class="product__items--content__title"><a href="/shop/@{{row.id}}">Durable A Steel </a></h4>
                    <div class="product__items--price">
            ...
            <div class="single__widget widget__bg">
              ...
              <ul class="widget__tagcloud">
                <li class="widget__tagcloud--list" ng-repeat="row in brands"><a class="widget__tagcloud--link" href="/shop">@{{row.name}}</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-xl-9 col-lg-8">
          <div class="shop__product--wrapper">
            <div class="tab_content">
              <div id="product_grid" class="tab_pane active show" ng-if="data.length > 0">
                <div class="product__section--inner product__grid--inner">
                  <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                    <div class="col mb-30" dir-paginate="row in data|filter:{name: keyword}|itemsPerPage:itemsPerPage">
                      <div class="product__items ">
                        ...
                        <div class="product__items--content">
                          ...
                          <h3 class="product__items--content__title h4"><a href="/shop/@{{row.id}}">@{{row.name}}</a></h3>
                          <div class="product__items--price">
              ...
              <div id="product_list" class="tab_pane" ng-if="data.length > 0">
                    ...
                    <div class="col mb-30" dir-paginate="row in data|filter:{name: keyword}|itemsPerPage:itemsPerPage">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">@{{row.category.name}}</span>
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">@{{row.name}}</a></h3>
              ...
              <div class="text-center" width="100%" ng-if="data.length == 0">
                <h1>Not founded</h1>
              </div>
            </div>
...
@section('js')
<script src="/assets/js/controllers/client/shopController.js"></script>
@stop