...
@section('content')
<main class="main__content_wrapper" ng-controller="productsController">
        ...
        <div class="product__view--mode d-flex align-items-center">
          ...
          <div class="product__view--mode__list product__view--search d-none d-lg-block">
            <form class="product__view--search__form" action="#">
              <label>
                <input class="product__view--search__input border-0" placeholder="Search by" type="text" spellcheck="false" data-ms-editor="true">
              </label>
              ...
              <div id="product_grid" class="tab_pane active show">
                <div class="product__section--inner product__grid--inner">
                  <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                    <div class="col mb-30" dir-paginate="row in data|itemsPerPage:itemsPerPage">
                  ...
                  <div class="row row-cols-1 mb--n30">
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          ...
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">Oversize Cotton Dress</a></h3>
                    ...
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">Jacket, Women</span>
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">Boxy Denim Jacket</a></h3>
                          <div class="product__list--items__price mb-10">
                    ...
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">Jacket, Women</span>
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">Quilted Shoulder Bag</a></h3>
                          <div class="product__list--items__price mb-10">
                    ...
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">Jacket, Women</span>
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">Square Shoulder Bag</a></h3>
                          <div class="product__list--items__price mb-10">
                    ...
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">Jacket, Women</span>
                          <h3 class="product__list--items__content--title h4 mb-10"><a href="/shop/@{{row.id}}">Light Denim Jackets</a></h3>
                          <div class="product__list--items__price mb-10">
                    ...
                    <div class="col mb-30">
                      <div class="product__items product__list--items d-flex">
                        ...
                        <div class="product__list--items__content">
                          <span class="product__items--content__subtitle mb-5">Jacket, Women</span>
                          <h4 class="product__list--items__content--title mb-10"><a href="/shop/@{{row.id}}">OSmock Mini Dresss</a></h4>
                          <div class="product__list--items__price mb-10">
