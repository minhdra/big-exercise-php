          ...
          <div class="price__filter--form__inner mb-15 d-flex align-items-center">
            <div class="price__filter--group">
              ...
              <div class="price__filter--input border-radius-5 d-flex align-items-center">
                ...
                <label>
                  <input class="price__filter--input__field border-0" id="fromPrice" type="number" placeholder="0" min="0" max="250.00">
                </label>
              </div>
            </div>
            ...
            <div class="price__filter--group">
              ...
              <div class="price__filter--input border-radius-5 d-flex align-items-center">
                <span class="price__filter--currency">$</span>
                <label>
                  <input class="price__filter--input__field border-0" id="toPrice" type="number" min="0" placeholder="250.00" max="250.00">
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
          ...
          <div class="product__view--mode d-flex align-items-center">
            <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
              <label class="product__view--label">Items :</label>
              <div class="select shop__header--select">
                <select class="product__view--select" ng-model="itemsPerPage">
            ...
            <div class="product__view--mode__list product__view--search d-none d-lg-block">
              <form class="product__view--search__form" action="#">
                <label>
                  <input class="product__view--search__input border-0" placeholder="Search by" type="text" ng-model="keyword">
                </label>
          ...
          <p class="product__showing--count">Showing @{{itemsPerPage}} of @{{totalItems}} results</p>
        </div>
        <div class="row">
                ...
                <div id="product_grid" class="tab_pane active show">
                  <div class="product__section--inner product__grid--inner">
                    <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                      <div class="col mb-30" dir-paginate="row in data|itemsPerPage:itemsPerPage | filter: {name: keyword}" total-items="totalItems">
                        <div class="product__items ">
                          <div class="product__items--thumbnail">
                            <a class="product__items--link" href="product-details.html">
                              <img class="product__items--img product__primary--img" src="@{{row.image_avatar}}" alt="product-img">
                          ...
                          <div class="product__items--content">
                            ...
                            <div class="product__items--price">
                              <span class="current__price">$@{{row.price.price_current}}</span>
                              <span class="price__divided"></span>
                              <span class="old__price">$@{{row.price.price_origin}}</span>
                            </div>
                            <ul class="rating product__rating d-flex">
                              <li class="rating__list">
                                <span class="rating__list--icon">
                ...
                <div id="product_list" class="tab_pane">
                  <div class="product__section--inner">
                    <div class="row row-cols-1 mb--n30">
                      <div class="col mb-30" dir-paginate="row in data|itemsPerPage:itemsPerPageList">
                        <div class="product__items product__list--items d-flex">
                          ...
                          <div class="product__list--items__content">
                            ...
                            <h3 class="product__list--items__content--title h4 mb-10"><a href="product-details.html">@{{row.name}}</a></h3>
            ...
            <div class="quickview__product--media product__details--media">
              <div class="product__media--preview  swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" ng-repeat="color in item.color[colorIndex].image">
                    <div class="product__media--preview__items">
                      <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="@{{color}}"><img class="product__media--preview__items--img" src="@{{color}}" alt="product-media-img"></a>
                      <div class="product__media--view__icon">
                        <a class="product__media--view__icon--link glightbox" href="@{{color}}" data-gallery="product-media-preview" target="_blank">
                ...
                <div class="swiper-wrapper">
                      <div class="swiper-slide" ng-repeat="color in item.color[colorIndex].image">
                        <div class="product__media--nav__items">
                          <img class="product__media--nav__items--img" src="@{{color}}" alt="product-nav-img">
                        </div>
                      </div>
                </div>
            ...
            <div class="quickview__info">
              <form action="#">
                ...
                <div class="product__details--info__price mb-10">
                  <span class="current__price">$@{{item.price.price_current}}</span>
                  <span class="old__price">$@{{item.price.price_origin}}</span>
                </div>
                ...
                <div class="product__variant">
                  <div class="product__variant--list mb-10">
                    <fieldset class="variant__input--fieldset">
                      ...
                      <div class="d-flex">
                        <div style="margin-right: .8rem;" ng-repeat="color in item.color">
