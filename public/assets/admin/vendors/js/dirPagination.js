    ...
    function makeCurrentPageGetterFn(scope, attrs, paginationId) {
      ...
      if (attrs.currentPage) {
        ...
        var defaultCurrentPage =
          '_' + (paginationId + '__currentPage').replace(/\W/g, '_');
  ...
  function dirPaginationControlsTemplateInstaller($templateCache) {
    $templateCache.put(
      ...
      `
            ...
            <li ng-if="boundaryLinks" ng-class="{ disabled : pagination.current == 1 }" class="paginate_button page-item previous" id="DataTables_Table_0_previous"><a ng-click="setCurrent(1)" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" class="page-link">&laquo;</a></li>
            <li ng-if="boundaryLinks" ng-class="{ disabled : pagination.current == 1 }" class="paginate_button page-item previous" id="DataTables_Table_0_previous"><a  ng-click="setCurrent(pagination.current - 1)" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" class="page-link">&lsaquo;</a></li>
            <li class="paginate_button page-item" ng-repeat="pageNumber in pages track by tracker(pageNumber, $index)" ng-class="{ active : pagination.current == pageNumber, disabled : pageNumber == \'...\' || ( ! autoHide && pages.length === 1 ) }"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link"  ng-click="setCurrent(pageNumber)">{{ pageNumber }}</a></li>
            <li class="paginate_button page-item next" id="DataTables_Table_0_next"  ng-if="directionLinks" ng-class="{ disabled : pagination.current == pagination.last }"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="7" tabindex="0" class="page-link"  ng-click="setCurrent(pagination.current + 1)">&rsaquo;</a></li>
            <li class="paginate_button page-item next" id="DataTables_Table_0_next"  ng-if="directionLinks" ng-class="{ disabled : pagination.current == pagination.last }"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="7" tabindex="0" class="page-link"  ng-click="setCurrent(pagination.last)">&raquo;</a></li>
          </ul>
            `
    );
  }
