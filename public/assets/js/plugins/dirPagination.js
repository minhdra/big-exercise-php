    ...
    $templateCache.put(
      ...
      `
        <div class="pagination__area bg__gray--color">
            <nav class="">
                <ul class="pagination pagination__wrapper d-flex align-items-center justify-content-center" ng-if="1 < pages.length || !autoHide">
                    <li ng-if="boundaryLinks" ng-class="{ disabled : pagination.current == 1 }" class="pagination__list" > 
                        <a href="" class="pagination__item link" ng-click="setCurrent(1)">&laquo;</a>
                    </li>
                    <li ng-if="directionLinks" ng-class="{ disabled : pagination.current == 1 }" class="pagination__list">
                        <a href=""  class="pagination__item link" ng-click="setCurrent(pagination.current - 1)">&lsaquo;</a>
                    </li>
                    <li ng-repeat="pageNumber in pages track by tracker(pageNumber, $index)" ng-class="{ active : pagination.current == pageNumber, disabled : pageNumber == \'...\' || ( ! autoHide && pages.length === 1 ) }" class="pagination__list">
                        <a href="" ng-class="{ 'pagination__item--current' : pagination.current == pageNumber, link : pageNumber == \'...\' || ( ! autoHide && pages.length === 1 ) }" ng-click="setCurrent(pageNumber)" class="pagination__item">{{ pageNumber }}</a>
                    </li>
                    <li ng-if="directionLinks" ng-class="{ disabled : pagination.current == pagination.last }" class="pagination__list">
                        <a href="" class="pagination__item link" ng-click="setCurrent(pagination.current + 1)">&rsaquo;</a>
                    </li>
                    <li ng-if="boundaryLinks"  ng-class="{ disabled : pagination.current == pagination.last }" class="pagination__list">
                        <a href="" class="pagination__item link" ng-click="setCurrent(pagination.last)">&raquo;</a>
                    </li>
                </ul > 
            </nav>
        </div>
