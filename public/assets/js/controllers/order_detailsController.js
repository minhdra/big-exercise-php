const nameDetail = 'order_details/';
const nameS = 'category/';

app.controller('order_detailsController', order_detailsController);
function order_detailsController($scope, $http) {
  ...
  // Get all order_d etails
  const loadData = () => {
    connect_api('GET', apiBase + nameDetail, null, function (res) {
